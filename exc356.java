...
public class exc356 {
    ...
    public static void main(String[] args) {
        ...
        for (int L = 0; L < quantidadeAlunos; L++) {
            ...
            nomes[L] = JOptionPane.showInputDialog(null, "Digite o " + (L + 1) + " nome:", "Entrada de dados",
            ...
            while (true) {
                try {
                    String input1 = JOptionPane.showInputDialog(null, "Digite 1ª nota:", "Entrada de dados",
                            JOptionPane.PLAIN_MESSAGE);
                    pr1[L] = Double.parseDouble(input1);
                    break;
                } catch (NumberFormatException e) {
                    JOptionPane.showMessageDialog(null, "Nota inválida. Digite novamente.", "Erro",
            ...
            while (true) {
                try {
                    String input2 = JOptionPane.showInputDialog(null, "Digite 2ª nota:", "Entrada de dados",
                            JOptionPane.PLAIN_MESSAGE);
